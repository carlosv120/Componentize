...
namespace Sabio.Web.StartUp
{
    public class DependencyInjection
    {
        public static void ConfigureServices(IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddSingleton<IFriendServiceV2,FriendServiceV2>();

            services.AddSingleton<IFriendServiceV3,FriendServiceV3>();

            services.AddSingleton<ITechCompaniesService, TechCompaniesService>();
